...
# The official BIP39 English wordlist (all 2048 words)
OFFICIAL_BIP39 = [
    ...
    "exact","example","exceed","excuse","execute","exercise","exhaust","exhibit","exile",
    "exist","exit","exotic","expand","expect","expire","explain","expose","extend",
    ...
    "inspire","install","intact","interest","into","invest","invite","iron","island",
    ...
    "quick","quit","quiz","quote","rabbit","raccoon","race","rack","radar","radio","rail",
    ...
    "suggest","suit","sun","sunny","sunset","super","supply","support","sure","surface",
    "surgery","surprise","surround","survey","suspect","sustain","swallow","swamp","swap",
    "swarm","swear","sweet","swift","swim","swing","switch","sword","symbol","symptom",
    "syrup","system","table","tackle","tag","tail","talent","talk","tank","tape","target",
    ...
    "viable","vibrant","vicious","video","view","village","vintage","violin","virtual",
...
assert len(OFFICIAL_BIP39) == 2048, f"Official list has {len(OFFICIAL_BIP39)} words"
...
if match:
    text = match.group(1)
    current_words = re.findall(r'"(\w+)"', text)
    print(f"Current unique words: {len(set(current_words))}")
    print(f"Current total words: {len(current_words)}")

# Find missing words
current_set = set(current_words)
missing = [w for w in OFFICIAL_BIP39 if w not in current_set]
